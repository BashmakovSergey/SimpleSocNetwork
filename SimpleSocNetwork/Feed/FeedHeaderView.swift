...
final class FeedHeaderView: UITableViewHeaderFooterView {
    ...
    private lazy var subscriberTitleLabel: CustomLabel = {
        let label = CustomLabel(labelText: "Subscriber posts", fontsize: 14, fontColor: .textMainBlack, alignment: .center)
        label.layer.borderWidth = 1
        label.layer.borderColor = UIColor.textMainBlack.cgColor
