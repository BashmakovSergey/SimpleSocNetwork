...
final class FinishViewController: UIViewController {
    ...
    public lazy var textTitleLabel: CustomLabel = {
        ...
        let label = CustomLabel(labelText: textLabel, fontsize: 22, fontColor: .textMainBlack, alignment: .center)
        return label
    }()
    
    private lazy var textDescriptionLabel: CustomLabel = {
        let label = CustomLabel(labelText: "We sent an SMS with a code to the number".localized + "\n\(myPhoneNumber ?? "")", fontsize: 14, fontColor: .textMainBlack, alignment: .center)
        return label
    }()
    
    private lazy var textEnterSMSLabel: CustomLabel = {
        let label = CustomLabel(labelText: "Enter the code from the SMS", fontsize: 15, fontColor: .textMainBlack, alignment: .center)
        return label
    }()
    
    public lazy var enterSMSTextField: CustomTextField = {
        let textField = CustomTextField(textHolder: "__-__", colorText: .textMainBlack, cornerRadius: 10)
    ...
    public lazy var registerButton: CustomButton = {
        ...
        let button = CustomButton(titleText: textButton, titleSize: 19, titleColor: .textMainWhite, backgroundColor: .butttonBackgroundBlack, tapAction: buttonMainTabBarAction)
        button.alpha = 0.2
