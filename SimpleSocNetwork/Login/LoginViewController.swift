...
final class LoginViewController: UIViewController {
    ...
    private lazy var textTitleLabel: CustomLabel = {
        let label = CustomLabel(labelText: "Welcome back", fontsize: 22, fontColor: .textMainBlack, alignment: .center)
        return label
    }()
    
    private lazy var textDescriptionLabel: CustomLabel = {
        let label = CustomLabel(labelText: "Enter your phone number to log in to the app", fontsize: 14, fontColor: .textMainBlack, alignment: .center)
        return label
    }()
    
    private lazy var phoneTextField: CustomTextField = {
        let textField = CustomTextField(textHolder: "+7(___)___-__-__", colorText: .textMainBlack, cornerRadius: 10)
    ...
    private lazy var nextButton: CustomButton = {
        let button = CustomButton(titleText: "CONFIRM", titleSize: 19, titleColor: .textMainWhite, backgroundColor: .butttonBackgroundBlack, tapAction: buttonLoginFinishAction)
        button.alpha = 0.2
