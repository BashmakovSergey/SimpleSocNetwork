...
final class RegisterViewController: UIViewController {
    ...
    private lazy var textTitleLabel = CustomLabel(labelText: "REGISTER", fontsize: 22, fontColor: .textMainBlack, alignment: .center)
    
    private lazy var phoneLabel = CustomLabel(labelText: "Enter the number", fontsize: 24, fontColor: .textMainBlack, alignment: .center)
   
    private lazy var descriptionLabel = CustomLabel(labelText: "Your number will be used to log in to your account", fontsize: 12, fontColor: .textMainBlack, alignment: .center)
    
    private lazy var phoneTextField: UITextField = {
        let textField = CustomTextField(textHolder: "+7(___)___-__-__", colorText: .textMainBlack, cornerRadius: 12)
    ...
    private lazy var nextButton: UIButton = {
        let button = CustomButton(titleText: "NEXT", titleSize: 19, titleColor: .textMainWhite, backgroundColor: .butttonBackgroundBlack, tapAction: buttonRegisterFinishAction)
        button.alpha = 0.2
    ...
    private lazy var descriptionBottonLabel: UILabel = {
        let label = CustomLabel(labelText: "By clicking the “Next” button You accept the User Agreement and the privacy policy", fontsize: 12, fontColor: .textMainBlack, alignment: .center)
        label.alpha = 0.2
        return label
    }()
