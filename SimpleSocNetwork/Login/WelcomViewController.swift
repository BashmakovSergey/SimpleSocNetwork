...
final class WelcomViewController: UIViewController {
    ...
    private lazy var signupButton = CustomButton(titleText: "REGISTER", titleSize: 19, titleColor: .textMainWhite , backgroundColor: .butttonBackgroundBlack, tapAction: buttomRegistrerAction)
    
    private lazy var loginButton = CustomButton(titleText: "login to your account", titleSize: 19, titleColor: .textMainBlack, backgroundColor: .backgroundMainGray, tapAction: buttomLoginAction)
