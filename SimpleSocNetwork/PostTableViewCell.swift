...
final class PostTableViewCell: UITableViewCell {
    ...
    private lazy var nameLabel: CustomLabel = {
        let label = CustomLabel(labelText: "unknown", fontsize: 16, fontColor: .textMainBlack, alignment: .left)
        return label
    }()
    ...
    private lazy var postImageView: UIImageView = {
        ...
        imageView.clipsToBounds = true
        imageView.backgroundColor = .textMainWhite
        return imageView
    }()
    ...
    private lazy var likeButton: UIButton = {
        let button = CustomButton(titleText: "\(likeTotal)", titleSize: 15, titleColor: .textMainBlack, backgroundColor: .backgroundMainGray, tapAction: changerLike)
    ...
    private lazy var commitButton: UIButton = {
        let button = CustomButton(titleText: "\(commitTotal)", titleSize: 15, titleColor: .textMainBlack, backgroundColor: .backgroundMainGray, tapAction: changerCommit)
    ...
    private lazy var favoriteButton: UIButton = {
        let button = CustomButton(titleText: "", titleSize: 0, titleColor: .systemOrange, backgroundColor: .backgroundMainGray, tapAction: changerFavorite)
    ...
    private func setupUI() {
        contentView.backgroundColor = .textMainWhite
