...
final class ProfileHeaderView: UITableViewHeaderFooterView {
    ...
    public lazy var avatarImageView: UIImageView = {
        ...
        imageView.layer.borderColor = UIColor.textMainBlack.cgColor
    ...
    private lazy var nameLabel: CustomLabel = {
        let label = CustomLabel(labelText: "unknown", fontsize: 18, fontColor: .textMainBlack, alignment: .left)
        return label
    }()

    private lazy var jobLabel: CustomLabel = {
        let label = CustomLabel(labelText: "unknown", fontsize: 14, fontColor: .textMainBlack, alignment: .left)
        return label
    }()

    public lazy var infoButton: UIButton = {
        let button = CustomButton(titleText: "Detailed information", titleSize: 12, titleColor: .textMainBlack, backgroundColor: .clear, tapAction: nil)
    ...
    public lazy var editButton: UIButton = {
        let button = CustomButton(titleText: "Edit", titleSize: 19, titleColor: .textMainWhite, backgroundColor: .systemOrange, tapAction: nil)
    ...
    public lazy var messageButton: UIButton = {
        let button = CustomButton(titleText: "Message", titleSize: 19, titleColor: .textMainWhite, backgroundColor: .systemOrange, tapAction: nil)
        button.titleLabel?.textAlignment = .center
        return button
    }()

    public lazy var subscribeButton: UIButton = {
        let button = CustomButton(titleText: "Subscribe", titleSize: 19, titleColor: .textMainWhite, backgroundColor: .systemOrange, tapAction: nil)
    ...
    private lazy var numberPublicationButton: UIButton = {
        let button = CustomButton(titleText: "Publications", titleSize: 19, titleColor: .textMainBlack, backgroundColor: .clear, tapAction: nil)
    ...
    public lazy var numberSubscriptionsButton: UIButton = {
        let button = CustomButton(titleText: "Subscriptions", titleSize: 19, titleColor: .textMainBlack, backgroundColor: .clear, tapAction: nil)
        button.contentHorizontalAlignment = .center
        button.titleLabel?.numberOfLines = 0
        button.titleLabel?.textAlignment = .center
        button.tag = 1
    ...
    public lazy var numberSubscribersButton: UIButton = {
        let button = CustomButton(titleText: "Subscribers", titleSize: 19, titleColor: .textMainBlack, backgroundColor: .clear, tapAction: nil)
        button.contentHorizontalAlignment = .center
        button.titleLabel?.numberOfLines = 0
        button.titleLabel?.textAlignment = .center
        button.tag = 0
    ...
    private lazy var bottomLineView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor.textMainBlack
        return view
    }()
    ...
    public lazy var postButton: UIButton = {
        let button = CustomButton(titleText: "Post", titleSize: 14, titleColor: .textMainBlack, backgroundColor: .clear, tapAction: nil)
        button.setImage(UIImage(systemName: "square.and.pencil"), for: .normal)
        button.imageView?.tintColor = .textMainBlack
        return button
    }()

    public lazy var storiesButton: UIButton = {
        let button = CustomButton(titleText: "History", titleSize: 14, titleColor: .textMainBlack, backgroundColor: .clear, tapAction: nil)
    ...
    public lazy var photoButton: UIButton = {
        let button = CustomButton(titleText: "Photo", titleSize: 14, titleColor: .textMainBlack, backgroundColor: .clear, tapAction: nil)
