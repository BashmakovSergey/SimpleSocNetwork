...
final class ProfileInfoViewController: UIViewController {
    ...
    private lazy var infoView: UIView = {
        ...
        view.layer.borderColor = UIColor.textMainBlack.cgColor
        return view
    }()
    
    private lazy var titleLabel: CustomLabel = {
        let label = CustomLabel(labelText: "Profile", fontsize: 21, fontColor: .textMainBlack, alignment: .left)
        return label
    }()
    ...
    private lazy var cancelButton: UIButton = {
        let button = CustomButton(titleText: "", titleSize: 0, titleColor: .textMainBlack, backgroundColor: .backgroundMainGray, tapAction: closeViewController)
    ...
    private func setupUI() {
        view.backgroundColor = UIColor.textMainBlack.withAlphaComponent(0.4)
