...
final class SubscriptionViewController: UIViewController {
    ...
    public lazy var subscriptionSegmentControl: UISegmentedControl = {
        ...
        segmentedControl.backgroundColor = .backgroundMainGray
        let textColorSelected = [NSAttributedString.Key.foregroundColor: UIColor.textMainWhite]
        let textColorNormal = [NSAttributedString.Key.foregroundColor: UIColor.textMainBlack]
...
extension SubscriptionViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        deleteAction.backgroundColor = UIColor.textMainBlack
