...
final class StoriesViewController: UIViewController {
    ...
    private lazy var nameLabel: CustomLabel = {
        let label = CustomLabel(labelText: "unknown", fontsize: 12, fontColor: .textMainWhite, alignment: .center)
    ...
    private lazy var exitButton: UIButton = {
        let button = CustomButton(titleText: "", titleSize: 12, titleColor: .textMainWhite, backgroundColor: .systemOrange, tapAction: buttonDissmissAction)
    ...
    private lazy var pushStoriesButton: CustomButton = {
        let button = CustomButton(titleText: "Share", titleSize: 19, titleColor: .textMainWhite, backgroundColor: .systemOrange, tapAction: buttonPushStoriesAction)
